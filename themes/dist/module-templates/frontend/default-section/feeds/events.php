<div class="title-section col-md-3 mb-4 ">
    ...
    <?php if (have_rows('sociale_media', 'options')) :
        echo '<div class="social-media">';
        // Loop through rows.
        while (have_rows('sociale_media', 'options')) : the_row();

            // Load sub field value.
            $sub_value = get_sub_field('channel', 'options');
            echo '<a class="social-icon" href="' . get_sub_field('link_to_channel', 'options') . '"><i class="fab fa-' . $sub_value . '"></i></a>';
                            ...
                            <div class="col-md-4 card-item project-item ">
                                <a class="d-block bg-white" href="<?php the_permalink(); ?>">
                                    ...
                                    <div class="p-3 d-flex flex-column justify-content-between">
                                        <div class="card-details d-flex mb-2 color-green"><?= get_the_date() ?></div>
