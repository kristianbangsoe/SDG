...
$acf_settings               = array(
    ...
    'options_page'              => array(
        'page_title' 	            => __('Theme General Settings', 'SDG'),
        'menu_title'	            => __('Theme Settings', 'SDG'),
    ...
    'options_sub_pages'         => array(
        array(
            'page_title' 	        => __('Theme Header Settings', 'SDG'),
            'menu_title'	        => __('Header', 'SDG'),
            'parent_slug'	        => 'theme-general-settings',
        ),
        array(
            'page_title' 	        => __('Theme Footer Settings', 'SDG'),
            'menu_title'	        => __('Footer', 'SDG'),
            'parent_slug'	        => 'theme-general-settings',
        )
    ),
    'theme_acf_path'            => '../../../plugins/advanced-custom-fields-pro/',
);
 ...
 */
add_filter('acf/settings/save_json', 'SDG_acf_json_save_point');
function SDG_acf_json_save_point( $path ) {
